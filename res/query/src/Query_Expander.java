...
import org.semanticweb.owlapi.vocab.OWLRDFVocabulary;
    ...
    public class Query_Expander {
        ...
        public Query_Expander(String ontologyFilename) {
        ...
        public static void main(String[] args) {
            ...
            Query_Expander queryExpander = new Query_Expander(
            ...
            Set<OWLClass> descendants = queryExpander.getSubClasses(term, true);
            for (OWLClass cls : descendants) {
                ...
                if (!cls.isBuiltIn()) {
                    ...
                    Set<String> labels = queryExpander.getClassAnnotations(cls);
